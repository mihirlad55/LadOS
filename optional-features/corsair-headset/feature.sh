...
readonly BASE_CONF="$BASE_DIR/30-corsair.conf"
readonly NEW_CONF="/etc/X11/xorg.conf.d/30-corsair.conf"

source "$LAD_OS_DIR/common/feature_header.sh"

readonly FEATURE_NAME="Configure Corsair"
readonly FEATURE_DESC="Install custom corsair configuration for Xorg"
readonly PROVIDES=()
