...
new_files=( \
    ...
    "$INSTALL_PATH/suckless-notify.timer" \
    "$TARGET_PATH/suckless-notify.timer" \
...
function install() {
    ...
    command install -Dm 644 "$SERVICE_PATH/suckless-notify.timer" "$INSTALL_PATH/suckless-notify.timer"
...
function post_install() {
    ...
    ln -sPf "$INSTALL_PATH/suckless-notify.timer" "$TARGET_PATH/suckless-notify.timer"
