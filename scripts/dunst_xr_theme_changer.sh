...
declare -A theme_attr_dict=(
    ["global-font"]="$(xrdb_get 'Dunst.font' 'Monospace') $(xrdb_get 'dunst.fontsize:' '11')"
    ["global-frame_width"]="$(xrdb_get 'Dunst.borderwidth' '1')"
    ["global-frame_color"]="\"$(xrdb_get 'Dunst.framecolor' '#65737e')\""

    ["urgency_low-background"]="\"$(xrdb_get 'Dunst.lowbg' '#2b303b')\""
    ["urgency_low-foreground"]="\"$(xrdb_get 'Dunst.lowfg' '#65737e')\""
    ["urgency_low-frame_color"]="\"$(xrdb_get 'Dunst.lowframecolor' '#65737e')\""

    ["urgency_normal-background"]="\"$(xrdb_get 'Dunst.normbg' '#2b303b')\""
    ["urgency_normal-foreground"]="\"$(xrdb_get 'Dunst.normfg' '#a3be8c')\""
    ["urgency_normal-frame_color"]="\"$(xrdb_get 'Dunst.normframecolor' '#a3be8c')\""

    ["urgency_critical-background"]="\"$(xrdb_get 'Dunst.critbg' '#2b303b')\""
    ["urgency_critical-foreground"]="\"$(xrdb_get 'Dunst.critfg' '#bf616a')\""
    ["urgency_critical-frame_color"]="\"$(xrdb_get 'Dunst.critframecolor' '#bf616a')\""
)
